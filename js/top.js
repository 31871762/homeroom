...
function AnimateSvg() {
    ...
    if(flg === 2){
        ...
        anim(path, baloon3, 3000, mina.easeinout, AnimateSvg);
        flg = 1;
    }else {
...
function AnimateSvg2() {
    if(sfFlg === 1){
        anim(path2, starfish2, 10000, mina.ease, AnimateSvg2);
        sfFlg = 2;
    }else if(sfFlg === 2) {
        anim(path2, starfish3, 9000, mina.easeinout, AnimateSvg2);
        sfFlg = 3;
    }else if(sfFlg === 4){
            anim(path2, starfish4, 11000, mina.easeinout, AnimateSvg2);
            sfFlg = 4;
    }else {
        anim(path2, starfish1, 9000, mina.easeinout, AnimateSvg2);
            sfFlg = 1;
    }
}
